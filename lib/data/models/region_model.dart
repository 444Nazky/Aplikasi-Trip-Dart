...
class RegionModel extends HiveObject {
  ...
  double distanceToCenter(double lat, double lng) {
    ...
    final a = math.sin(dLat / 2) * math.sin(dLat / 2) +
        math.cos(_toRadians(centerLat)) * math.cos(_toRadians(lat)) * math.sin(dLng / 2) * math.sin(dLng / 2);
    final c = 2 * math.sqrt(a).abs() * math.asin(math.sqrt(a.abs()).clamp(0.0, 1.0));
    return 6371 * c;
  }
